...
class MatchingEngine:
    ...
    def submit_market(self,
        ...
        # Create the limit order (aggresive) based on what it was given 
        order = Order(side=side, order_type=OrderType.MARKET, qty=qty)
        list_trades = []
        ...
        while order.qty > 0: 
            ...
            opposite_levels = self.book.levels_for(side.opposite) # It's returning all the dict
            matching_level = opposite_levels[opposite_price] # It starts with the best price 
